...
function keyPressed(){
	...
	{
	Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-30,y:-32});
	}
}
function keyPressedright(){
	if(keyCode === RIGHT_ARROW)
	{
	Matter.Body.applyForce(bob2.body,bob2.body.position,{x:-30,y:-32});
	}
}
